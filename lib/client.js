...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      '.vm-cell-zone{--vm-peak:#f5941b;--vm-valley:#3b6ef5;color-scheme:dark;position:relative;display:flex;justify-content:flex-end;align-items:center;min-height:26px;font-size:var(--dsw-font-s-14-font-size,14px);pointer-events:auto;box-sizing:border-box}',
      ...
      '.vm-trackline{position:absolute;right:0;top:100%;width:min(300px,64%);box-sizing:border-box;animation:vm-pop-in .2s ease;z-index:49}',

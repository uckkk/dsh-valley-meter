...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      '.vm-cell-zone{--vm-peak:#f5941b;--vm-valley:#3b6ef5;color-scheme:dark;position:relative;display:flex;justify-content:flex-end;align-items:flex-end;min-height:22px;font-size:var(--dsw-font-s-14-font-size,14px);pointer-events:auto;padding:2px 10px 0 4px;box-sizing:border-box}',
      ...
      '.vm-trackline{position:absolute;right:0;top:100%;width:min(280px,58%);box-sizing:border-box;animation:vm-pop-in .2s ease;z-index:49}',
      // 时间轴主体:圆角短线;刻度(0-24)放在轴上方。

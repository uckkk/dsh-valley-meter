...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.vm-card{display:flex;flex-direction:column;gap:10px;padding:12px 14px;border-radius:16px;background:var(--dsw-alias-bg-base,#151517);border:1px solid rgba(255,255,255,.06);width:100%;max-width:100%;box-sizing:border-box;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.08);container-type:inline-size}',
      '.vm-top{display:flex;align-items:center;justify-content:center;font-variant-numeric:tabular-nums}',
      '.vm-countdown{font-size:var(--dsw-font-xl-24-font-size,24px);font-weight:600;line-height:1.2;letter-spacing:.3px;color:var(--dsw-alias-label-primary,inherit)}',
      ...
      '.vm-track{position:relative;height:6px;min-width:0;border-radius:999px;background:var(--dsw-alias-bg-layer-3,transparent);box-shadow:inset 0 0 0 1px rgba(255,255,255,.08)}',
      '.vm-seg{position:absolute;top:0;height:100%}',
      '.vm-seg-peak{background:var(--vm-peak)}',
      '.vm-seg-valley{background:var(--vm-valley)}',
      '.vm-block{position:absolute;top:50%;width:8px;height:8px;border-radius:2px;transform:translate(-50%,-50%);pointer-events:auto;z-index:0;box-shadow:0 0 0 1px rgba(0,0,0,.25)}',
      ...
      '.vm-marker{position:absolute;top:-7px;width:3px;height:calc(100% + 14px);background:#fff;transform:translateX(-50%);transition:left .5s ease;z-index:2;border-radius:2px;box-shadow:0 0 6px rgba(255,255,255,.5);animation:vm-breathe 2.4s ease-in-out infinite}',
      ...
      '.vm-cell-title{font-size:var(--dsw-font-xs-13-font-size,13px);color:var(--dsw-alias-label-secondary,inherit);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      '.vm-cell-value{font-size:var(--dsw-font-l-20-font-size,20px);font-weight:500;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary,inherit);white-space:nowrap}',
      ...
      '@container (max-width:330px){.vm-badge{display:none}.vm-countdown{font-size:var(--dsw-font-l-20-font-size,20px)}.vm-ticks span:nth-child(2),.vm-ticks span:nth-child(4){display:none}}',
    ]
